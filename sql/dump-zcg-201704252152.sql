...
INSERT INTO `admin_log` VALUES (1,'/category/update?id=2','alex修改了app\\models\\Categoryid:cate_id的cate_name : foods=>food',1492953807,3),(2,'/admin/menu/update?id=14','alex修改了mdm\\admin\\models\\Menuid:id的parent : 1=>1,order : 3=>4',1492954720,3);
...
INSERT INTO `auth_assignment` VALUES ('普通用户','6',1492950135),('用户管理员','4',1492320748),('用户管理员','6',1492950140),('超级管理员','3',1492255036),('超级管理员','6',1492950138);
...
INSERT INTO `auth_item_child` VALUES ('权限管理','/admin/*'),('权限管理','/admin/default/*'),('权限管理','/admin/default/index'),('用户管理','/admin/default/index'),('权限管理','/admin/menu/*'),('权限管理','/admin/menu/create'),('权限管理','/admin/menu/delete'),('权限管理','/admin/menu/index'),('权限管理','/admin/menu/update'),('权限管理','/admin/menu/view'),('权限管理','/admin/permission/*'),('权限管理','/admin/permission/assign'),('权限管理','/admin/permission/create'),('权限管理','/admin/permission/delete'),('权限管理','/admin/permission/index'),('权限管理','/admin/permission/remove'),('权限管理','/admin/permission/update'),('权限管理','/admin/permission/view'),('权限管理','/admin/role/*'),('权限管理','/admin/role/assign'),('权限管理','/admin/role/create'),('权限管理','/admin/role/delete'),('权限管理','/admin/role/index'),('权限管理','/admin/role/remove'),('权限管理','/admin/role/update'),('权限管理','/admin/role/view'),('权限管理','/admin/route/*'),('权限管理','/admin/route/assign'),('权限管理','/admin/route/create'),('权限管理','/admin/route/index'),('权限管理','/admin/route/refresh'),('权限管理','/admin/route/remove'),('权限管理','/admin/rule/*'),('权限管理','/admin/rule/create'),('权限管理','/admin/rule/delete'),('权限管理','/admin/rule/index'),('权限管理','/admin/rule/update'),('权限管理','/admin/rule/view'),('权限管理','/admin/user/*'),('权限管理','/admin/user/activate'),('权限管理','/admin/user/assign'),('权限管理','/admin/user/change-password'),('权限管理','/admin/user/delete'),('权限管理','/admin/user/index'),('权限管理','/admin/user/login'),('权限管理','/admin/user/logout'),('权限管理','/admin/user/request-password-reset'),('权限管理','/admin/user/reset-password'),('权限管理','/admin/user/revoke'),('权限管理','/admin/user/signup'),('权限管理','/admin/user/update'),('权限管理','/admin/user/view'),('商品管理','/category/*'),('商品管理','/category/create'),('商品管理','/category/delete'),('商品管理','/category/index'),('商品管理','/category/update'),('商品管理','/category/view'),('操作日志','/log/*'),('操作日志','/log/create'),('操作日志','/log/delete'),('操作日志','/log/index'),('操作日志','/log/update'),('操作日志','/log/view'),('商品管理','/product/*'),('商品管理','/product/create'),('商品管理','/product/delete'),('商品管理','/product/index'),('商品管理','/product/update'),('商品管理','/product/view'),('后台首页','/site/flush-cache'),('后台首页','/site/index'),('普通用户','后台首页'),('超级管理员','后台首页'),('超级管理员','商品管理'),('超级管理员','操作日志'),('超级管理员','权限管理'),('用户管理员','用户管理'),('超级管理员','用户管理');
...
INSERT INTO `category` VALUES (1,'phone','2011-11-11 11:11:01'),(2,'food','2011-11-11 11:11:01');
...
INSERT INTO `product` VALUES (1,'Iphone 6s',1,5400,'the best phone in the world',2147483647),(2,'Iphone 5e',2,3000,'cheap iphone',2147483647),(5,'fawefawfe',1,5400,'fawefa',1492818583),(6,'awefawef',1,5400,'fawfewafe',1492819001),(7,'awefawef',1,5400,'fawfewafe',1492819022),(8,'awefawef',1,5400,'fawfewafe',1492819070),(9,'awefawef',1,5400,'fawfewafe',1492819107),(10,'awefawef',1,5400,'fawfewafe',1492819136),(11,'awefawef',1,5400,'fawfewafe',1492819148),(12,'awefawef',1,5400,'fawfewafe',1492819173);
...
-- Dump completed on 2017-04-25 21:52:22
